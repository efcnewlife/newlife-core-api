...
class LogoutRequest(BaseModel):
    """Logout request"""
    access_token: str = Field(..., description="Access token to blacklist", serialization_alias="accessToken")
    refresh_token: Optional[str] = Field(None, description="Refresh token to blacklist", serialization_alias="refreshToken")
