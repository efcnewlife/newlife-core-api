...
class SharePointArchiveProvider:
    """Upload the account/Ministry CSV pair to `SHAREPOINT_TEST_ACCOUNT_FOLDER`."""
    ...
    async def upload_csv_pair(self, *, account_csv: Path, ministry_csv: Path) -> None:
        ...
        folder = settings.SHAREPOINT_TEST_ACCOUNT_FOLDER
