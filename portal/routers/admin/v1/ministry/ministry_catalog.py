...
@router.get(path="/ministry-types", status_code=status.HTTP_200_OK, response_model=AdminMinistryTypeList, permissions=[Permission.MINISTRY_MINISTRY.read])
@inject
...
@router.get(path="/target-audiences", status_code=status.HTTP_200_OK, response_model=AdminTargetAudienceList, permissions=[Permission.MINISTRY_MINISTRY.read])
@inject
