...
from portal.application.auth.mappers import (
    member_login_result_to_api,
    member_profile_result_to_api,
    token_result_to_api,
)
...
@router.post(
    ...
    responses={
        ...
        403: {
            ...
            "content": {"application/json": {"example": {"detail": "Unknown or missing web app Origin"}}},
        },
    },
)
@inject
async def member_microsoft_login(
    ...
    result = await microsoft_auth_service.microsoft_member_login(
...
async def member_logout(
    ...
    await refresh_token_service.logout_member(
