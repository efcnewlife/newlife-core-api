...
**Status: Partially superseded by ADR 0025.** The HTTP authentication contract remains accepted; the single-account provisioning and persona/ministry-seeding boundary are superseded by the Mock QA data lifecycle.
